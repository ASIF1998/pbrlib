...
TEST(SceneGraphSpotLightNode, Constructor)
{
    ...
    SpotLightNode node1;
    SpotLightNode node2(name2, nullptr, light_builder);
    PtrSpotLightNode node3 = SpotLightNode::make(name3, &node2, ptr_point_light);
    ...
    EXPECT_EQ(outer_radius, node3->getLight()->getOuterRadius())    << "Не правильное инициализирование источника света." << endl;
    EXPECT_EQ(inner_radius, node3->getLight()->getInnerRadius())    << "Не правильное инициализирование источника света." << endl;
}
